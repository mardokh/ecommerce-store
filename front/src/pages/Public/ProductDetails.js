                ...
                <div className="details_sideImg_image_parent_container">
                            ...
                            <div className="details_side_img">
                                {product.product_images.map((file, index) => (
                                    <div 
                                        ...
                                        style={{backgroundImage: `url('${process.env.REACT_APP_REMOTE_URL}/uploads/${file.images}')`}} onClick={() => cornerImageDisplay(file.images, index)}>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="details_img_row_fav_icon">
                        ...
                        <div className="details_img_rows_container">
                            ...
                            <div className="details_img_container" style={{backgroundImage: `url('${process.env.REACT_APP_REMOTE_URL}/uploads/${nextImageActive ? nexImage : product.image}')`}}></div>
