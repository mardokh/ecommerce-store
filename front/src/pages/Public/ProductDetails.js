    ...
    return (
        <div className="details_global_container">
            <section className="details_parent_container">
                ...
                <div className="details_img_info_global_container">
                    <div className="details_img_container" style={{backgroundImage: `url('http://${process.env.REACT_APP_REMOTE_ADDR}:${process.env.REACT_APP_SERVER_PORT}/uploads/${nextImageActive ? nexImage : product.image}')`}}>
                    ...
                    <div className="details_info_sub_container">
                        ...
                        <div className="details_quantity_container">
                            <button>-</button>
                            <input value={0} style={{fontSize: "20px", padding: "10px"}}/>
                            <button>+</button>
                        </div>
