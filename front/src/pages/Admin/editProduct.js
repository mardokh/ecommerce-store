            ...
            <div className='edit_product_form_global_container'>
                <div className='edit_product_form_container'>
                    <div className='edit_product_principale_image_container'>
                        ...
                        <div className="edit_product_image" style={{backgroundImage: `url('${!imageFlag ? `${process.env.REACT_APP_REMOTE_URL}/uploads/${product.image}` : imageUrl}')`}}></div>
                    </div>
                    ...
                    <div className="edit_product_image_container" ref={imagesDisplayContainerRef}>
                        {product.images.map((image, index) => (
                            <div className="edit_product_images_container" key={index}>
                                ...
                                <div className="edit_product_images" style={{backgroundImage: `url('${image.images ? `${process.env.REACT_APP_REMOTE_URL}/uploads/${image.images}` : URL.createObjectURL(image)}')`}}></div>
                            </div>
                        ))}
                    </div>
                </div>
