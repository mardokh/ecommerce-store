                                    ...
                                    <div className="details_recipe_reviews_item" key={comment.id}>
                                        ...
                                        {comment.user_id == user_id &&
                                            <div className="details_recipe_reviews_icons_container">
                                                <svg className="details_recipe_reviews_icon" viewBox="0 0 20 20" onClick={() => editReview(comment.id, comment.comment, comment.note)}>
                                                ...
                                                <svg className="details_recipe_reviews_icon" viewBox="0 0 20 20" onClick={() => deleteReview(comment.id)}>
