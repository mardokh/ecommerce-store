            ...
            <div className="recipes_parent_container">
                ...
                recipes.map(recipe => (
                    <div key={recipe.id} className='pics_container_sub'>
                        ...
                        <Link to={`/recette_details/${recipe.id}`}><div className='pics_container' style={{backgroundImage: `url('${process.env.REACT_APP_REMOTE_URL}/uploads/${recipe.image}')`}}></div></Link>
