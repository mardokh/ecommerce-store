                        ...
                        <tbody>
                            {!refNotFound ? (
                                currentTableData.map(recipe => (
                                    <tr key={recipe.id}>
                                        <td className='recipe_manage_img_container' style={{backgroundImage: `url('http://${process.env.REACT_APP_REMOTE_ADDR}:${process.env.REACT_APP_SERVER_PORT}/uploads/${recipe.image}')`}}></td>
                                        <td>{recipe.name}</td>
