...
const RecipesNotesComments = DB.recipesNotesComments
...
const recalculateReviews = async () => {
    ...
    const result = await RecipesNotesComments.findAll({
        attributes: [
            'recipe_id',
...
// ADD REVIEWS //
exports.addRecipesNotesComments = async (req, res) => {
    ...
    try {
        ...
        const recipeNoted = await RecipesNotesComments.findAll({where: {user_id: user_id, recipe_id: recipe_id}})
        ...
        if (recipeNoted.length !== 0) {
            ...
            // Create recipe note
            await RecipesNotesComments.create({
            user_id: user_id,
            recipe_id: recipe_id,
            comment: comment,
            note: note
...
// GET ALL REVIEWS //
exports.getRecipesNotesComments = async (req, res) => {
    ...
    try {
        ...
        // Get comments & notes
        const recipesNotesComments = await RecipesNotesComments.findAll({
        ...
        if (!recipesNotesComments.length > 0) {
        ...
        return res.json({ data: [{recipesNotesComments, RecipesNotesLevels}] })
...
// UPDATE REVIEW //
exports.updateRecipesNotesComments = async (req, res) => {
    ...
    try {
        ...
        // Update review
        await RecipesNotesComments.update(req.body, {where: {user_id: user_id}})
...
// DELETE REVIEWS //
exports.deleteRecipesNotesComments = async (req, res) => {
    ...
    try {
        ...
        // Get reveiws
        const reveiws = await RecipesNotesComments.findOne({where: {id: reviewId}})
        ...
        // Delete reviwes
        await RecipesNotesComments.destroy({where: {id: reviewId}, force: true})
